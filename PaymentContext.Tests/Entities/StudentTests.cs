...
namespace PaymentContext.Tests.Entities
{
  ...
  public class StudentTests
  {
    ...
    public StudentTests()
    {
      _name = new Name("Dudu", "Mendonça");
      _document = new Document("78965412314", EDocumentType.CPF);
      _email = new Email("dudu@du.com");
      _address = new Address("Rua 1", "1234", "Bairro Legal", "SP", "BR", "12345689");
